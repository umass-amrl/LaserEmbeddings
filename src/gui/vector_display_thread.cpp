...
#include "gui_msgs/CobotLocalizationSrv.h"
...
using gui_msgs::CobotAnomalyMonitorRectangleMsg;
//using gui_msgs::CobotHumansDetected;
using gui_msgs::CobotLocalizationMsg;
using gui_msgs::CobotLocalizationSrv;
using gui_msgs::CobotRemoteInterfaceSrv;
using gui_msgs::CobotStatusMsg;
using gui_msgs::LidarDisplayMsg;
...
// void VectorDisplayThread::humanTrackingCallback(const gui_msgs::CobotHumansClassified& msg)
// {
...
void VectorDisplayThread::statusCallback(
  ...
  static const bool debug = false;
  const gui_msgs::LidarDisplayMsgConstPtr &msg = msgEvent.getConstMessage();
