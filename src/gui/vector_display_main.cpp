...
#include "gui_msgs/GuiMouseMoveEvent.h"
#include "gui_msgs/LocalizationGuiCaptureSrv.h"
#include "util.h"
#include "geometry.h"
#include "popt_pp.h"
...
gui_msgs::GuiMouseMoveEvent mouse_move_msg_;
gui_msgs::GuiMouseClickEvent mouse_click_msg_;
gui_msgs::GuiKeyboardEvent keyboard_events_msg_;
...
bool CaptureCallback(gui_msgs::LocalizationGuiCaptureSrv::Request& req,
                     gui_msgs::LocalizationGuiCaptureSrv::Response& res) {
...
int main(int argc, char *argv[]) {
  ...
  mouse_move_publisher_ =
      node_handle.advertise<gui_msgs::GuiMouseMoveEvent>(
      "Gui/VectorLocalization/GuiMouseMoveEvents", 1, false);
  mouse_click_publisher_ =
      node_handle.advertise<gui_msgs::GuiMouseClickEvent>(
      "Gui/VectorLocalization/GuiMouseClickEvents", 1, false);
  keyboard_events_publisher_ =
      node_handle.advertise<gui_msgs::GuiKeyboardEvent>(
      "Gui/VectorLocalization/GuiKeyboardEvents", 1, false);
