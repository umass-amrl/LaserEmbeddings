...
//#include "gui_msgs/CobotHumansDetected.h"
//#include "gui_msgs/CobotHumansClassified.h"
#include "gui_msgs/CobotRemoteInterfaceSrv.h"
#include "gui_msgs/CobotStatusMsg.h"
#include "gui_msgs/CobotLocalizationMsg.h"
#include "gui_msgs/CobotAnomalyMonitorRectangleMsg.h"
...
//  NavigationMap navMap;
  ...
  float anomalyURY;
  float anomaly;
  //gui_msgs::CobotHumansDetected humansMsg;
  //gui_msgs::CobotHumansClassified classifiedHumansMsg;
  sensor_msgs::LaserScan laserScanMsg;
  sensor_msgs::LaserScan kinectScanMsg;
  sensor_msgs::PointCloud pointCloudMsg;
  std::vector<gui_msgs::LidarDisplayMsg> displayMsgs;
...
public:
  ...
  void cobotLocalizationCallback(
      const gui_msgs::CobotLocalizationMsg& msg);

  void cobotAnomalyCallback(
      const gui_msgs::CobotAnomalyMonitorRectangleMsg& msg);

  void kinectScanCallback(const sensor_msgs::LaserScan& msg);

  void laserCallback(const sensor_msgs::LaserScan& msg);

  void cobotStatusCallback(const gui_msgs::CobotStatusMsg& msg);

  //void humanDetectionCallback(const gui_msgs::CobotHumansDetected& msg);

  //void humanTrackingCallback(const gui_msgs::CobotHumansClassified& msg);

  void statusCallback(
      const ros::MessageEvent<const gui_msgs::LidarDisplayMsg>& msgEvent);
